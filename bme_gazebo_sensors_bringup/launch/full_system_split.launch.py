...
def generate_launch_description():
    ...
    motion_executor_container = ComposableNodeContainer(
        name='motion_executor_container',
        namespace='',
    ...
    goal_bridge_container = ComposableNodeContainer(
        name='goal_bridge_container',
        namespace='',
        package='rclcpp_components',
        executable='component_container',
        composable_node_descriptions=[
    ...
    return LaunchDescription([
        ...
        rosapi_node,
        map_to_odom_tf,
        motion_executor_container,
        goal_bridge_container,
    ])